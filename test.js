...
async function handleRequest(request) {
  ...
  // 🔹 Root protection
  // Simplified: Only redirect if it's clearly a desktop/mobile browser visiting the root
  if (pathname === '/' || pathname === '/index.json') {
    if (userAgent.includes('mozilla') && !userAgent.includes('ott') && !userAgent.includes('player')) {
